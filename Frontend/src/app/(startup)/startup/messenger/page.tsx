...
export default function StartupMessengerPage() {
  ...
  return (
    <div className="w-full h-[calc(100vh-6rem)] flex flex-col md:flex-row rounded-xl border border-border bg-card shadow-sm overflow-hidden">
      {/* Conversation list */}
      <div className="w-full md:w-[320px] flex flex-col border-b md:border-b-0 md:border-r border-border bg-muted/20 dark:bg-zinc-900/50">
        <div className="shrink-0 px-5 py-4 border-b border-border">
          ...
          <p className="text-sm text-muted-foreground mt-1.5">Chat with contributors</p>
        </div>
          ...
          {loadingConversations ? (
            ...
            <div className="px-5 py-8 text-center">
              ...
              <p className="text-sm text-muted-foreground mt-1 max-w-[220px] mx-auto">
                Open a contributor profile and click Message to start chatting.
              </p>
            </div>
          ) : (
                    ...
                    <button
                      ...
                      className={`w-full flex items-center gap-3 px-3 py-3 rounded-xl text-left transition-all duration-200 ${
                        active
                          ...
                          : 'hover:bg-muted/80 dark:hover:bg-zinc-800/80'
                      }`}
                    >
          ...
          <div className="flex-1 flex items-center justify-center p-8">
            <div className="text-center max-w-sm">
              ...
              <p className="text-sm text-muted-foreground mt-2">
                Choose a chat from the list or open a contributor profile and click Message to start.
              </p>
            </div>
          </div>
        ) : (
